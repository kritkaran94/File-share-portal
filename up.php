			...
			<div class="content-wrapper">
				...
				<section class="content">
					...
					<div class="row">
										...
										<table class="table no-margin">
											...
											<tbody>
												...
												<tr>
													<td><a href="#">9.4</a></td>
													<td>Inception</td>
													<td><span class="label label-danger">Uploaded</span></td>
													
												</tr>
												<tr>
													<td><a href="#">8.2</a></td>
													<td>Dabang</td>
													<td><span class="label label-info">Uploaded</span></td>
													
												</tr>
												<tr>
													<td><a href="#">8.5</a></td>
													<td>Bajrangi Bhaijan</td>
													<td><span class="label label-info">Uploaded</span></td>
						...
						<fieldset>
						<legend>Please Add the files here:</legend>
						Category:<br>
						<br>
						<select>
							<option value="volvo">Movies</option>
							<option value="saab">Books</option>
							<option value="opel">Software</option>
							<option value="audi">Images</option>
							<option value="audi">Other</option>
						</select>						
						<br>
						<br>
						Multiple/Single File :<br>
						<br>
						<input type="file" name="file" multiple />
						<br><br>
						<input type="submit" name="btn-upload" value="Submit">
						</fieldset>
						</form>
